...
if("TRUE" STREQUAL "TRUE")
  set(display_SOURCE_PREFIX /home/ed/lab_10/src/display)
  set(display_DEVEL_PREFIX /home/ed/lab_10/devel)
  set(display_INSTALL_PREFIX "")
  set(display_PREFIX ${display_DEVEL_PREFIX})
else()
  set(display_SOURCE_PREFIX "")
  set(display_DEVEL_PREFIX "")
  set(display_INSTALL_PREFIX /home/ed/lab_10/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'display' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ed/lab_10/src/display/${idir}'.  ${_report}")
    endif()
