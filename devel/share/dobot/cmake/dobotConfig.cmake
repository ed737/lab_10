...
if("TRUE" STREQUAL "TRUE")
  set(dobot_SOURCE_PREFIX /home/ed/lab_10/src/dobot)
  set(dobot_DEVEL_PREFIX /home/ed/lab_10/devel)
  set(dobot_INSTALL_PREFIX "")
  set(dobot_PREFIX ${dobot_DEVEL_PREFIX})
else()
  set(dobot_SOURCE_PREFIX "")
  set(dobot_DEVEL_PREFIX "")
  set(dobot_INSTALL_PREFIX /home/ed/lab_10/install)
...
if(NOT "/home/ed/lab_10/devel/include " STREQUAL " ")
  set(dobot_INCLUDE_DIRS "")
  set(_include_dirs "/home/ed/lab_10/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'dobot' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ed/lab_10/src/dobot/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ed/lab_10/devel/lib;/opt/ros/melodic/lib)
